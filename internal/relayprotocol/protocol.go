// Package relayprotocol defines the frame format used to talk to the relay.
// Must match the protocol in huzaa-relay.
...
// ReadFrame reads one frame: 1 byte type + 4 byte length (big-endian) + payload.
